...
<div class="pagetitle">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Cheque's Lists</li>
    </ol>
    </nav>
</div><!-- End Page Title -->


<a href="/cheques/create" class="btn btn-outline-dark mt-3 ms-3">
    <i class="bi bi-file-plus-fill fs-4 align-middle"></i>
    <span class="align-middle">New Cheque</span>
  </a>
